...
def tc(training_file_name, test_file_name):
	...
	d_word_cat = dict() #dictionary that stores the number of times the word appears in the category
	d_cat = dict() #dictionary that stores the numer of tokens/category
	d_prior = dict() #dictionary that counts files/category
